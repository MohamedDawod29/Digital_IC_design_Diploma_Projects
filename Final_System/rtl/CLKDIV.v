...
(
	...
	assign toggeling_value = I_div_ratio_c >> 1;
	assign is_odd = I_div_ratio_c[0] ? 1'b1 : 1'b0;                       // if LSB of I_div_ratio is 1 so it's odd else it's even value
	assign clk_div_enable = (enable && I_div_ratio_c != 0 && I_div_ratio_c != 1);
